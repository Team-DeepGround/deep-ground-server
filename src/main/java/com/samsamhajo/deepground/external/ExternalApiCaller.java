package com.samsamhajo.deepground.external;

import com.samsamhajo.deepground.external.kakao.exception.ExternalApiErrorCode;
import com.samsamhajo.deepground.external.kakao.exception.ExternalApiException;
...
public class ExternalApiCaller {
    ...
    public <R> R get(String url, Map<String, String> headers, Map<String, String> queryParams, ParameterizedTypeReference<R> responseType) {
        return execute(() -> {
            ...
            // queryParams에 미리 인코딩된 값을 넣음 (이중 인코딩 방지)
            if (queryParams != null) {
                queryParams.forEach((key, value) -> {
                    String encodedValue = null;  // 수동 인코딩
                    try {
