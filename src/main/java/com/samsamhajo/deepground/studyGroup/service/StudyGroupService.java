...
public class StudyGroupService {
  ...
  public Page<StudyGroupResponse> searchStudyGroups(StudyGroupSearchRequest request) {
    ...
    OnOffline onOffline = request.getOnOffline();


    Page<StudyGroup> pageResult = studyGroupRepository.searchWithFilters(status, keyword, stackNames, onOffline ,pageable );
